...
#EDUREKA
"""the __init__ function is called automaticaly every time the the class is 
...
"""
#we can also use the super() functio to automatically inherit all the atrributes from the 
